...
export default function Home() {
    ...
    return (
        <div className="bg-pink-50 dark:bg-gray-900 min-h-screen text-gray-800 dark:text-gray-100 font-sans overflow-hidden">
            <Head>
                <title key="title">마사지콜 - 전국 출장 마사지 / 출장 마사지 / 마사지</title>
                ...
                <meta name="google-site-verification" content="bVY09vdPGmkmlqLpz7MzExozitVHImNJ13pywLRSZDc" />
            </Head>
            {/* 헤더 높이만큼 패딩 적용 */}
            <div className="pt-[72px]">
                <section className="min-h-[35vh] md:min-h-[30vh] flex flex-col items-center justify-center relative overflow-visible">
                    ...
                    <div className="mt-4 md:mt-[10px] w-full relative">
                        <InfiniteRightSlider items={logos} duration={1100} />
                    </div>
                </section>
